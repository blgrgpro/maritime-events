...
export const industryUpdates: IndustryUpdate[] = [
  {
    ...
    newsItems: [
      ...
      {
        title: "Maersk CEO commits to expanding dual-fuel orderbook to 35 vessels following MEPC 85 GHG deal",
        url: "https://www.lloydslist.com/LL1158100/Maersk-CEO-commits-expanding-methanol-orderbook-35-vessels-post-MEPC-85",
        source: "Lloyd's List",
        date: "25 May 2026",
      },
      {
  ...
  },
  {
    ...
    newsItems: [
      ...
      {
        title: "Kongsberg Maritime shares rise 8% on first day of independent trading on Oslo Bors",
        url: "https://www.tradewindsnews.com/maritime-technology/kongsberg-maritime-first-day-trading-independent-oslo-listed-shares-rise/2-1-1960050",
        source: "TradeWinds",
        date: "24 May 2026",
      },
    ],
  },
  {
    ...
    newsItems: [
      ...
      {
        title: "DNV publishes MEPC 85 compliance guide for shipowners navigating the new GHG fuel intensity levy",
        url: "https://splash247.com/dnv-publishes-mepc-85-compliance-guide-ghg-fuel-intensity-levy/",
        source: "Splash247",
        date: "25 May 2026",
      },
    ],
